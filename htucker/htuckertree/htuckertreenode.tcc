...
template <typename T>
HTuckerTreeNode<T>::HTuckerTreeNode(const HTuckerTreeNode<T> &_copy):index(_copy.getIndex()),UorB(_copy.getUorB()),UorB_numel(_copy.UorB_numel),UorB_rcnumel(_copy.UorB_rcnumel),UorB_lcnumel(_copy.UorB_lcnumel){};
