namespace htucker{
	...
	GeneralTreeNode<NType>::GeneralTreeNode(const NType &_content):parent(NULL),firstChild(NULL),lastChild(NULL),nextSibling(NULL),lastSibling(NULL),levelleft(NULL),levelright(NULL),content(_content){}
